...
{
    [Route("api/peliculas/{peliculaId:int}/reviews")] // api/2/review
    ...
    public class ReviewController:CustomBaseController
    {
        ...
        public ReviewController(AplicationDbContext context, IMapper mapper)
        :base(context, mapper)
        {
        ...
        {            
            ...
            if (reviewExiste) return BadRequest($"Ya se ha realizado una review para la película {peliculaId}");
