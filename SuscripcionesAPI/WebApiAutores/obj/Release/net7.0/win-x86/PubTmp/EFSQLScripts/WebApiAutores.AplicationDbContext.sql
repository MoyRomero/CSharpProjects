...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230517023947_Inicial')
BEGIN
...
BEGIN
    CREATE TABLE [Comentarios] (
        ...
        CONSTRAINT [FK_Comentarios_AspNetUsers_UsuarioId] FOREIGN KEY ([UsuarioId]) REFERENCES [AspNetUsers] ([Id]),
...
BEGIN
    ...
    VALUES (N'20230517023947_Inicial', N'7.0.5');
END;
GO
